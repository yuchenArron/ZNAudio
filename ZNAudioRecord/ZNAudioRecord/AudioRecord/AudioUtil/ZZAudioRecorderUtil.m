...
// 开始录音
+ (NSString*)startRecordingWithPreparePath:(NSString *)aFilePath
                           completion:(void(^)(NSError *error))completion{
    return [[ZZAudioRecorderUtil shareInstance] startRecoredWithPath:aFilePath completion:completion];
}
// 停止录音
...
- (NSString*)startRecoredWithPath:(NSString *)path
                  completion:(void(^)(NSError *error))completion{
    NSError *error = nil;
